		...
		<div class="exchange_rates clearfix">
				...
				<div class="info"><?php
					...
					<strong><?php
						echo __('If you are preparing the report to file the official VAT MOSS return, we ' .
										'recommend that you use the ECB exchange rates for the selected quarter.',
										$text_domain);
					?></strong>
			...
			<ul>
				...
				<li>
					...
					<label for="ecb_rates_for_quarter"><?php echo __('Use the European Central Bank (ECB) Rates for the selected quarter', $text_domain); ?></label>
				</li>
			</ul>
		</div>
		<?php
				...
				<div class="info">
					...
					<?php
						...
						echo __('If you choose to include refunded orders, then their amounts will be ' .
										...
										$text_domain);
					?>
					<h5><? echo __('Important', $text_domain); ?></h5>
					<?php
